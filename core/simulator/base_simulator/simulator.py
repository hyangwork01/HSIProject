...
from core.envs.base_env.env_utils.humanoid_utils import build_pd_action_offset_scale
from core.simulator.base_simulator.robot_state import RobotState, DataConversion
from core.simulator.base_simulator.config import MarkerState, VisualizationMarker, ControlType, SimulatorConfig, SimBodyOrdering
...
class Simulator(ABC):
    ...
    """
    把“模拟器内部的身体／关节顺序”↔“环境里统一的身体／关节顺序”建立好映射，并预先准备好 PD 控制需要的限位、偏移/缩放参数。
    """
