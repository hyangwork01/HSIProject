...
from core.utils.device_dtype_mixin import DeviceDtypeModuleMixin
...
# CT hack: remap phys_anim to core for backwards compatibility of pre-existing motion files
import sys
import core

sys.modules['phys_anim'] = core
