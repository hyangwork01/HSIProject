from protomotions.scenelib.scenelib import Scene,SceneObject,RigidOptions,SceneLib,ArticulationOptions
...
import os
from protomotions.scenelib.task.basetask import BaseTaskScene
import json
